...
#define ASSERT_NO_ERROR(x) do{try{x;}catch(GameException& e){cout<<"Failed assertion at line "<<__LINE__<<" in "<<__func__<<\
...
#define ASSERT_ERROR(x, error) do{ \
    ...
    catch(const GameException& e){cout<<"Failed assertion at line "<<__LINE__<<" in "<<__func__<<\
...
bool testErrorNames(){
    ...
    std::shared_ptr<Character> testCharacter1 = Game::makeCharacter(CharacterType::SOLDIER, Team::CPP, 1, 0, 2, 0);
    std::shared_ptr<Character> testCharacter2 = Game::makeCharacter(CharacterType::MEDIC, Team::CPP, 1, 10, 2, 0);
    Game testGame (10,10);
    ...
    ASSERT_ERROR_WITH_MESSAGE(testGame.move(GridPoint(1,1), GridPoint(3,1)), CellOccupied, "A game related error has occurred: CellOccupied");
...
bool testCopyConstructor(){
    ...
    ASSERT_NO_ERROR(g1.addCharacter(GridPoint(2,2), Game::makeCharacter(CharacterType::SOLDIER, Team::CPP, 1, 0, 10, 0)));
...
bool testAddCharacter(){
    ...
    ASSERT_ERROR(game.addCharacter(GridPoint(-1,1), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)), IllegalCell);
    ASSERT_ERROR(game.addCharacter(GridPoint(rows-1,cols), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)), IllegalCell);
    ASSERT_ERROR(game.addCharacter(GridPoint(rows,cols-1), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)), IllegalCell);
    ASSERT_ERROR(game.addCharacter(GridPoint(rows,cols), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)), IllegalCell);

    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)));
    ASSERT_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, CPP, 10, 0, 0, 0)), CellOccupied);
...
bool testMakeCharacter(){
    ...
    ASSERT_ERROR(Game::makeCharacter(SOLDIER, CPP, 0, 0, 0, 0), IllegalArgument);
    ASSERT_ERROR(Game::makeCharacter(SOLDIER, CPP, 0, 1, 2, 3), IllegalArgument);
    ASSERT_ERROR(Game::makeCharacter(SOLDIER, CPP, -1, 1, 2, 3), IllegalArgument);
...
bool testMove(){
    ...
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, CPP, 1, 1, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, CPP, 1, 1, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(5,5), Game::makeCharacter(SOLDIER, CPP, 1, 1, 0, 0)));
    ...
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
            ASSERT_NO_ERROR(game.addCharacter(GridPoint(i,j), Game::makeCharacter(SOLDIER, CPP, 1, 1, 0, 0)));
        }
    }
    ...
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
            ASSERT_NO_ERROR(game.addCharacter(GridPoint(i,j), Game::makeCharacter(MEDIC, CPP, 1, 1, 0, 0)));
        }
    }
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
    ...
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
            ASSERT_NO_ERROR(game.addCharacter(GridPoint(i,j), Game::makeCharacter(SNIPER, CPP, 1, 1, 0, 0)));
        }
    }
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
...
bool testAttackSoldier(){
    ...
    Game game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, CPP, 1, 1, 1, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,0), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ASSERT_TEST(checkGameContainsPlayerAt(game, GridPoint(0,0)));
    ...
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, CPP, 1, 1, 0, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,0), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ASSERT_TEST(checkGameContainsPlayerAt(game, GridPoint(0,0)));
    ...
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, CPP, 1, 1, 2, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,0), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ASSERT_TEST(checkGameContainsPlayerAt(game, GridPoint(0,0)));
    ...
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, CPP, 1, 1, 4, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,0), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,2), Game::makeCharacter(SOLDIER, CPP, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(2,0), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(2,1), Game::makeCharacter(SOLDIER, PYTHON, 1, 0, 0, 0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ASSERT_TEST(checkGameContainsPlayerAt(game, GridPoint(0,0)));
    ASSERT_TEST(checkGameContainsPlayerAt(game, GridPoint(0,1)));
    ASSERT_TEST(!checkGameContainsPlayerAt(game, GridPoint(1,0)));
    ...
    int range = 7;
    GridPoint selected(9,9);
    ASSERT_NO_ERROR(game.addCharacter(selected, Game::makeCharacter(SOLDIER, CPP, 1, 0, range, 0)));
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
            // If attacking in range and in same row/col, then expect OutOfAmmo
            ...
            // If attacking in range but not in same row/col, then expect OutOfAmmo (since preceds IllegalTarget)
                ...
                // Waste the generated ammo (no affect to hp since all on same team)
...
bool testAttackMedic(){
    ...
    Game game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(MEDIC, CPP, 1, 0, 1, 1)));

    // At time of writing, forum verified the following won't be tested
    // ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)), IllegalTarget);
    // ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)), OutOfAmmo);
    ASSERT_NO_ERROR(game.reload(GridPoint(0,0)));
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)), IllegalTarget);
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)), IllegalTarget);

    game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(MEDIC, CPP, 1, 0, 1, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 1, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(MEDIC, PYTHON, 1, 1, 1, 1)));
    ...
    game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(MEDIC, CPP, 1, 1, 1, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 1, 0, 1, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(MEDIC, PYTHON, 1, 1, 1, 1)));
    ASSERT_NO_ERROR(game.attack(GridPoint(1,1), GridPoint(0,1)));
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)), IllegalTarget);
    ...
    int range = 7;
    GridPoint selected(9,9);
    ASSERT_NO_ERROR(game.addCharacter(selected, Game::makeCharacter(MEDIC, CPP, 1, rows * cols + 1, range, 0)));
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
...
bool testAttackSniper(){
    ...
    int range = 7;
    GridPoint selected(9,9);
    ASSERT_NO_ERROR(game.addCharacter(selected, Game::makeCharacter(SNIPER, CPP, 1, 0, range, 0)));
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
    ...
    ASSERT_ERROR(game.attack(GridPoint(5,5), GridPoint(5,8)), IllegalTarget);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(5,8), Game::makeCharacter(SNIPER, CPP, 1, 0, 3, 0)));
    ASSERT_ERROR(game.attack(GridPoint(5,5), GridPoint(5,8)), IllegalTarget);

    ASSERT_NO_ERROR(game.addCharacter(GridPoint(5,2), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(2,5), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(8,5), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(5,3), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(3,5), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(7,5), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(5,7), Game::makeCharacter(SNIPER, PYTHON, 2, 0, 0, 0)));
...
bool testReload(){
    ...
    game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SOLDIER, PYTHON, 2, 1, 0, 4)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)), OutOfAmmo);
    ASSERT_NO_ERROR(game.reload(GridPoint(0,0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,0)));
    ...
    game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(MEDIC, PYTHON, 2, 1, 1, 4)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(MEDIC, CPP, 120, 10, 2, 1)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,0), Game::makeCharacter(MEDIC, PYTHON, 1, 1, 0, 4)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)));
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)), OutOfAmmo);
    ASSERT_NO_ERROR(game.reload(GridPoint(0,0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)));
    ...
    ASSERT_NO_ERROR(game.attack(GridPoint(0,1), GridPoint(1,0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,1), GridPoint(1,0)));
    ASSERT_ERROR(game.attack(GridPoint(0,1), GridPoint(1,0)), IllegalTarget);

    game = Game(rows,cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,0), Game::makeCharacter(SNIPER, PYTHON, 2, 1, 1, 4)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)));
    ASSERT_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)), OutOfAmmo);
    ASSERT_NO_ERROR(game.reload(GridPoint(0,0)));
    ASSERT_NO_ERROR(game.attack(GridPoint(0,0), GridPoint(0,1)));
...
bool testOutput(){
    ...
    Game game(rows, cols);
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(2,1), Game::makeCharacter(SOLDIER, PYTHON, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(4,1), Game::makeCharacter(MEDIC, CPP, 24, 0, 0, 0)));
...
bool testWinningTeam(){
    ...
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,2), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,3), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_TEST(game.isOver());
    ASSERT_TEST(game.isOver(nullptr));

    Team winning = PYTHON;
    ASSERT_TEST(game.isOver(&winning));
    ASSERT_TEST(winning == CPP);

    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, PYTHON, 24, 0, 0, 0)));
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(3,1), Game::makeCharacter(SOLDIER, PYTHON, 24, 0, 0, 0)));
    ASSERT_TEST(!game.isOver());
    ASSERT_TEST(!game.isOver(&winning));
    ASSERT_TEST(winning == CPP);
    ...
    ASSERT_TEST(!game.isOver());
    ASSERT_NO_ERROR(game.addCharacter(GridPoint(0,1), Game::makeCharacter(SOLDIER, PYTHON, 24, 0, 0, 0)));
    ASSERT_TEST(game.isOver());
    ASSERT_TEST(game.isOver(nullptr));

    ASSERT_TEST(game.isOver(&winning));
    ASSERT_TEST(winning == PYTHON);

    ASSERT_NO_ERROR(game.addCharacter(GridPoint(1,1), Game::makeCharacter(SOLDIER, CPP, 24, 0, 0, 0)));
    ASSERT_TEST(!game.isOver());
    ASSERT_TEST(!game.isOver(&winning));
    ASSERT_TEST(winning == PYTHON);
    ...
    for (int i = 0; i < rows; i++){
        for (int j = 0; j < cols; j++){
            if (GridPoint(i,j) == selected){
                ASSERT_NO_ERROR(game.addCharacter(GridPoint(i,j), Game::makeCharacter(SOLDIER, PYTHON, 1, 2, range, 2)));
            }
            else{
                ASSERT_NO_ERROR(game.addCharacter(GridPoint(i,j), Game::makeCharacter(SNIPER, CPP, 2, 0, 0, 0)));
            }
        }
    }
